...
public class Classify extends AppCompatActivity {
    ...
    private int DIM_IMG_SIZE_X = 220;
    private int DIM_IMG_SIZE_Y = 220;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        label1 = (TextView) findViewById(R.id.label2);
        label2 = (TextView) findViewById(R.id.label3);
        // displays the probabilities of top labels
        Confidence1 = (TextView) findViewById(R.id.Confidence2);
        Confidence2 = (TextView) findViewById(R.id.Confidence3);
...
//            Bitmap b =  getResizedBitmap(bitmap, 220,220);
...
//            selected_image.setRotation(selected_image.getRotation() + 90);
    ...
    private List<String> loadLabelList2() throws IOException {
        List<String> labelList = new ArrayList<String>();
        BufferedReader reader =
